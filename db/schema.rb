...
ActiveRecord::Schema[7.0].define(version: 2026_05_07_173410) do
  ...
  create_table "authors_papers", id: false, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "papers", charset: "utf8mb3", force: :cascade do |t|
